...
ENV SIMPLE_SAML_VERSION 2.3.7
WORKDIR /opt
ADD simplesamlphp-${SIMPLE_SAML_VERSION}.tar.gz.sha256 .
RUN curl -L -o simplesamlphp-${SIMPLE_SAML_VERSION}.tar.gz https://github.com/simplesamlphp/simplesamlphp/releases/download/v${SIMPLE_SAML_VERSION}/simplesamlphp-${SIMPLE_SAML_VERSION}-full.tar.gz && \
